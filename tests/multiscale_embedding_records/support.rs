...
pub(super) use marklab::{
    ...
    HierarchyNode, MultiscaleArtifactBinding, MultiscaleEmbeddingDerivationContract,
    MultiscaleEmbeddingError, MultiscaleEmbeddingSupport, MultiscaleEmbeddingSupportVariant,
