...
#[test]
fn sparse_radius_heat_replays_across_processes_and_invalidates_on_input_change() {
    ...
    changed["time"] = serde_json::json!(0.5);
    fs::write(&input, serde_json::to_vec(&changed).unwrap()).expect("changed fixture");
