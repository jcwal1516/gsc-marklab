...
#[test]
fn beta_binomial_group_regression_runs_once_then_replays_without_starting_pymc() {
...
msi-4,MSI,62,100\n",
    ...
    assert_eq!(
        result["model"]["family"],
        "patient_beta_binomial_group_regression"
    );
    ...
    assert_eq!(
        ...
        "pymc-beta-binomial-group-regression"
    );
    assert_eq!(
