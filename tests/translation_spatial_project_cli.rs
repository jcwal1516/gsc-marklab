...
#[test]
fn translation_kl_runs_as_a_fresh_process_miss_then_backend_disabled_hit() {
...
slide-1:000000001,1.5,0.5,0,case-1,baseline,unmarked,true,true,slide-1\n",
    ...
    assert_eq!(result["format"], "marklab.translation_spatial");
    assert_eq!(result["analysis"]["correction"], "translation");
    assert_eq!(result["analysis"]["curve"][0]["ordered_pairs"], 2);
    assert_eq!(
