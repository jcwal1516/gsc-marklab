...
pub use parquet::{
    ...
    preflight_patch_overlap_graph_parquet_bytes, publish_cell_embedding_row_link_parquet,
    publish_cell_embedding_table_parquet, publish_cell_patch_assignment_table_parquet,
    publish_cell_patch_edge_table_parquet, publish_patch_footprint_set_parquet,
    publish_patch_overlap_graph_parquet, read_cell_embedding_table_parquet_bytes,
    ...
    validate_patch_overlap_graph_parquet_from_store, verify_cell_embedding_row_link_parquet_bytes,
    ...
    CellEmbeddingParquetPreflight, CellEmbeddingRowLinkParquetPreflight,
