...
pub use multiscale::{
    ...
    PatchRegionAssessmentBindings, PatchRegionDeclaration, PatchRegionLink, PatchRegionRelation,
    PatchSourceEntityEntry, PatchSourceEntitySet, RegionEmbeddingBlock, RegionEmbeddingRow,
