...
use super::{
    ...
    ExpectedRegionSet, PatchEmbeddingTable, PatchRegionDeclaration, PatchRegionLink,
    RegionEmbeddingRow, RegionEmbeddingTable, VerifiedDerivedRegionEmbeddingArtifactGraph,
};
