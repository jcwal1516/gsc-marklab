...
| Canonical owner/symbol | Location | Contract | Principal callers | Tests/evidence | Active task |
|---|---|---|---|---|---|
| Durable project execution pseudocode constraint | `docs/implementation/pseudocode/01_part_i_shared_algorithmic_substrate.md` §§2.5–2.6; `docs/implementation/pseudocode/13_part_xiii_unified_execution_validation_and_release_contracts.md` §§121–123, 130–133 | Subordinate contract for run/artifact identity, execution mode, typed failure, transactional persistence, maturity, promotion, and kill gates; `PSEUDOCODE_AUTHORITY_AND_ERRATA.md` corrects mode selection and claim ceilings | `DurableProject`, `DurableExecutionRequest`, `NativeRuntimeProvenance`, project head/ledger/pending-intent owners; no direct generic executor caller | `python3 docs/implementation/verify_pseudocode_pack.py`; focused PLAT-DUR-01 behavior remains owned by its task contract/tests | PLAT-DUR-01 |
