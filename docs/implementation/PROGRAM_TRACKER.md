...
| FND-06 | active | Public InferenceDesign owns exact whole-unit schedules for patient-label, unblocked or exact patient-ID-keyed blocked population-independence MMD/energy/functional curves, paired complete-difference signs, complete subject-residual signs, and complete cell-mark random labeling. Conditional whole-pattern/fixed-pilot nulls and complete-row pair nulls remain method-bound; real TCGA/Schürch tests use patients. Hierarchical bootstrap, multisite/cluster/interference, and broader multiplicity ownership remain. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired-difference and complete-subject-residual signs, unblocked or exact patient-blocked population-independence MMD/energy/functional curves, single-step Max-T, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; hierarchical bootstrap ownership, remaining null families, calibration, and broader multiplicity require further FND-06 slices. |
