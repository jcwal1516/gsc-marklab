...
| FND-03 | active | One exact SpatialGeometryPlan2D and SpatialIndex2D now serve standard-border K/L and exact event/probe nearest queries for F/G/J with shared point/window identity and hard work bounds. General reusable distance-bin/edge-weight plans and broader endpoint adoption remain. |
...
| FND-06 | active | Public InferenceDesign owns exact whole-unit schedules for patient-label and cell-mark random labeling. Conditional whole-pattern CSR now drives K/L and F/G/J; real TCGA and Schürch energy/MMD tests use patient labels and patient as the population unit. Repeated/multisite/cluster/interference integration and broader multiplicity ownership remain. |
...
| PLAT-01 | active | Immutable artifacts, exact identities, durable heads/ledger/recovery/replay, and typed native/PyMC/POT execution now drive classical K/L, exact F/G/J, real TCGA M0–M4/M6, Schürch CODEX, and seven PyMC workflows. Dependency-bearing general multi-node orchestration remains. |
...
| WF-01 | active | Typed keys, exact artifact admission, sequential composition, and durable replay now include classical K/L, exact F/G/J, fixed-shard real TCGA M0–M4/M6, Schürch CODEX, and marked/Moran graphs. General workflow schema, heterogeneous construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-12 | active | Typed durable execution covers native/POT nodes, pinned PyMC fits, classical K/L, exact F/G/J, marked/Moran graphs, and real TCGA/Schürch patient workflows with byte-identical cross-process replay. General DAG construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-30 | active | Complete standard-border K/L and F/G/J workflows share exact window/geometry owners, conditional CSR, ERL inference, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous K/L, pair-correlation g, cross/marked functions, and intensity estimation remain. |
