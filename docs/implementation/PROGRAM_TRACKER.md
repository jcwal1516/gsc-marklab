...
| FND-03 | active | One exact SpatialGeometryPlan2D/SpatialIndex2D serves K/L, F/G/J, and the shared once-retained directed radius-pair plan now consumed by categorical and probability-weighted connection; observed/null evaluations reuse identical geometry under hard bounds. General edge-weight/bin plans and broader adoption remain. |
| FND-04 | active | A row-aligned typed MarkTable binds stable CellIds plus binary, probability, continuous, and provenance-bearing histologic-compartment categorical columns; declared analysis, Moran/Geary/variograms, categorical pairs, and probability-weighted connection are immediate callers. Ordinal, simplex, vector-reference, general categorical/interchange, real-IHC, and scale coverage remain. |
...
| MRK-01 | active | Exact categorical and expected probability-weighted mark connection share one bounded retained pair plan, complete-row random labeling, ERL, typed identities, and durable replay. Continuous mark correlation and mark-weighted K remain distinct open families. |
...
| MRK-01B | active | The finite typed continuous MarkTable column and shared pair/null plan are live prerequisites; the next caller must freeze the mean and normalization policy and deliver normalized continuous mark correlation. |
...
| NUL-01B | active | Exact scalar, complete-vector, categorical, and dense-probability whole-row random labeling are runnable; both pair workflows reuse one fixed geometry plan with explicit ERL families. Broader typed mark/strata calibration and stable promotion remain. |
...
| PLAT-01 | active | Immutable artifacts, exact identities, durable heads/ledger/recovery/replay, and typed native/PyMC/POT execution drive K/L, F/G/J, categorical connection/cross-K, expected probability connection, real TCGA M0–M4/M6, Schürch CODEX, and seven PyMC workflows. General multi-node orchestration remains. |
...
| WF-01 | active | Typed keys, store-verified semantic artifacts, exact admission, composition, and replay include K/L, F/G/J, categorical connection/cross-K, expected probability connection, real TCGA/Schürch fingerprints, and marked/Moran graphs. General schema, heterogeneous construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, K/L, F/G/J, store-verified categorical and probability connection, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-23 | active | Declared analysis, Moran/Geary/variograms, categorical connection/cross-K, and expected probability connection share the bounded row-aligned MarkTable. General categorical/ordinal/simplex/vector/interchange and canonical real-data import remain. |
...
| WS-30 | active | Standard-border K/L, F/G/J, categorical/probability connection, and directed cross-K share exact window/index/geometry owners, deterministic nulls, ERL, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous K/L, pair-correlation g/cross-g, continuous/weighted marks, and intensity estimation remain. |
