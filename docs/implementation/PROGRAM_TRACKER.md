...
| FND-02 | active | Exact bounded ObservationWindow2D owns polygon/multipolygon/hole topology, closed membership, indexed unsigned/signed distance, and optional physical-frame identity consumed by K/L, Moran/Geary, variograms, and exact F/G/J. Compartment partitions, volumes, and broader external geometry agreement remain. |
| FND-03 | active | One exact SpatialGeometryPlan2D/SpatialIndex2D serves K/L, F/G/J, and a once-retained directed radius-pair plan for categorical mark connection/cross-K; observed/null evaluations reuse identical geometry under hard bounds. General edge-weight/bin plans and broader adoption remain. |
| FND-04 | active | A row-aligned typed MarkTable binds stable CellIds plus binary, probability, continuous, and provenance-bearing histologic-compartment categorical columns; declared analysis, Moran/Geary/variograms, and categorical pair inference are immediate callers. Ordinal, simplex, vector-reference, general categorical/interchange, real-IHC, and scale coverage remain. |
...
| MRK-01 | active | Exact categorical mark connection is live with complete-row random labeling and a shared bounded pair plan. Probability-weighted connection, continuous mark correlation, and mark-weighted K remain distinct open families. |
| MRK-01A | active | The categorical half is complete for one exact provenance-bearing multi-level MarkTable column, directed level pair, border-eligible shell probability, componentwise ERL, control direction, and durable replay. Probability/simplex expected-contribution semantics remain. |
...
| NUL-01B | active | Exact scalar, complete-vector, and categorical whole-row random labeling are runnable; categorical connection/cross-K reuses one fixed geometry plan with explicit componentwise ERL families. Broader typed mark/strata calibration and stable promotion remain. |
...
| PLAT-01 | active | Immutable artifacts, exact identities, durable heads/ledger/recovery/replay, and typed native/PyMC/POT execution drive K/L, F/G/J, categorical connection/cross-K, real TCGA M0–M4/M6, Schürch CODEX, and seven PyMC workflows. General multi-node orchestration remains. |
...
| WF-01 | active | Typed keys, store-verified semantic artifacts, exact admission, composition, and replay include K/L, F/G/J, categorical connection/cross-K, real TCGA/Schürch fingerprints, and marked/Moran graphs. General schema, heterogeneous construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, K/L, F/G/J, store-verified categorical connection/cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-23 | active | Declared analysis, Moran/Geary/variograms, and categorical connection/cross-K share the bounded row-aligned MarkTable with binary/probability/continuous and one histologic-compartment categorical specialization. General categorical/ordinal/simplex/vector/interchange and canonical real-data import remain. |
...
| WS-30 | active | Standard-border K/L, F/G/J, categorical mark connection, and directed cross-K share exact window/index/geometry owners, deterministic nulls, ERL, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous K/L, pair-correlation g/cross-g, continuous/weighted marks, and intensity estimation remain. |
