...
| FND-06 | active | Public InferenceDesign owns exact whole-unit schedules for patient-label, unblocked or exact patient-ID-keyed blocked population-independence MMD/energy, and complete cell-mark random labeling. Conditional whole-pattern/fixed-pilot nulls and complete-row pair nulls remain method-bound; real TCGA/Schürch tests use patients. Functional-curve blocks, repeated/multisite/cluster/interference, and broader multiplicity ownership remain. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar/paired/functional patient permutation, unblocked or exact patient-blocked population-independence MMD/energy, single-step Max-T, complete-vector embedding nulls, and shared blocked patient-label/cell-mark/variogram schedules are runnable; remaining null families, calibration, and broader multiplicity require further FND-06 slices. |
