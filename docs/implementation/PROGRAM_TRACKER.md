...
| FND-03 | active | One exact SpatialGeometryPlan2D/SpatialIndex2D serves K/L, F/G/J, and the shared once-retained directed radius-pair plan now consumed by categorical/probability connection, continuous mark correlation, and mark-weighted K; observed/null evaluations reuse identical geometry under hard bounds. General edge-weight/bin plans and broader adoption remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, K/L, F/G/J, store-verified categorical/probability connection, continuous correlation/weighted K, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-30 | active | Standard-border K/L, F/G/J, categorical/probability connection, continuous correlation/weighted K, and directed cross-K share exact window/index/geometry owners, deterministic nulls, ERL, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous K/L, pair-correlation g/cross-g, and intensity estimation remain. |
