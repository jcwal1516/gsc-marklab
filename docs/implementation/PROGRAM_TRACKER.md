...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, homogeneous/inhomogeneous K/L and g, cross-g, F/G/J, store-verified categorical/probability connection, continuous correlation/weighted K, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
