...
| COH-01 | active | Scalar, paired, functional, Max-T, MMD/energy, fingerprint/region compatibility, equivalence, noninferiority, hierarchical bootstrap, repeated-measures, and patient-row fixed/REML multisite workflows are runnable; real CPTAC CellViT patient-unit four-endpoint Max-T evidence is bundled, while covariate-adjusted/cluster/interference designs and real multisite validation remain. |
...
| FND-06 | active | Public InferenceDesign owns exact whole-unit schedules for patient-label, unblocked or exact patient-ID-keyed blocked population-independence MMD/energy/functional curves, paired complete-difference signs, complete subject-residual signs, patient-then-nested-specimen hierarchical bootstrap, and complete cell-mark random labeling. Conditional whole-pattern/fixed-pilot nulls and complete-row pair nulls remain method-bound; real TCGA/Schürch tests use patients. Cluster/interference and broader multiplicity/calibration ownership remain. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired-difference/subject-residual signs, patient-then-nested-specimen bootstrap, unblocked or exact patient-blocked population-independence MMD/energy/functional curves, single-step Max-T, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; cluster/interference nulls, calibration, and broader multiplicity require further FND-06 slices. |
