...
| CAU-01 | active | IC-0130–IC-0135 and IC-0192–IC-0195 provide exact randomized mechanics, sensitivity, bounded synthetic observational/perturbation estimators, active design, and partial validation; randomized interference and analytic Gaussian EIG now have typed durable project replay. Admitted real treatment data, identification, and prospective outcomes remain promotion gaps. |
...
| DIM-01 | active | IC-0126 provides strict physical-unit/spacing dimensionality, cuboid-window, anisotropic-metric, and homogeneous 3-D K/L specialization with typed durable replay; general 3-D windows/geometry and provenance-complete serial/longitudinal cohorts with section order, thickness, deformation, and missing-section states remain missing. |
...
| WS-80 | active | IC-0126 provides a bounded synthetic physical-cuboid 3-D K/L workflow with exact correction oracles and typed durable replay; serial reconstruction, general windows/graphs/topology/fields, and real 3-D cohorts with section geometry, deformation uncertainty, and validation landmarks remain missing. |
| WS-81 | active | IC-0123 provides bounded time-varying linear-Gaussian filtering/RTS smoothing with exact synthetic and missing-observation oracles plus typed durable replay; repeated registered biological units, treatment/time metadata, and clone trajectories remain missing. Existing nonlinear and particle specializations remain direct-only. |
| WS-82 | active | IC-0130/IC-0192 supply randomized interference plus synthetic propensity/dose/AIPW/exposure-AIPW/DML/negative-control mechanics; randomized interference now has typed durable replay, while eligible real treatment data and identification remain missing. |
...
| WS-84 | active | IC-0132/IC-0194/IC-0195 supply analytic EIG, synthetic sequential/constrained selection, allocation/power, and partial validation; scalar Gaussian EIG now has typed durable replay, while prospective outcomes remain missing. |
