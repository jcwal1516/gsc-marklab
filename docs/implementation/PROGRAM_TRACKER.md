...
| COH-01 | active | Scalar, paired, functional, blocked and paired endpoint-family single-step/step-down Max-T, MMD/energy, fingerprint/region compatibility, equivalence, noninferiority, hierarchical bootstrap, repeated-measures, patient-row fixed/REML multisite, whole-cluster permutation, and exact randomized-interference workflows are runnable; real CPTAC CellViT patient-unit four-endpoint Max-T evidence is bundled, while covariate-adjusted designs and real multisite/cluster/interference validation remain. |
...
| FND-06 | active | Exact design owners cover patient labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, scalar and complete endpoint-vector paired signs, subject residuals, patient-then-specimen bootstrap, whole-cluster labels, complete cell-mark random labeling, and clustered randomized interference with fixed outcomes. Conditional whole-pattern/fixed-pilot nulls and complete-row pair nulls remain method-bound; hierarchical/local multiplicity and calibration ownership remain. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired scalar/vector and subject-residual signs, patient-then-specimen bootstrap, whole-cluster labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, exact randomized interference, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; calibration and hierarchical/local multiplicity require further FND-06 slices. |
