...
| COH-01 | active | Scalar, unblocked/blocked 1–32-covariate adjusted, paired, functional, blocked and paired endpoint-family single-step/step-down Max-T, MMD/energy, fingerprint/region compatibility, equivalence, noninferiority, hierarchical bootstrap, repeated-measures, patient-row fixed/REML multisite, whole-cluster permutation, and exact randomized-interference workflows are runnable; cluster/multisite adjustment and real multisite/cluster/interference validation remain. |
...
| FND-06 | active | Exact design owners cover patient labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, scalar and complete endpoint-vector paired signs, subject residuals, unblocked/blocked 1–32-covariate complete patient residual permutation, patient-then-specimen bootstrap, whole-cluster labels, complete cell-mark random labeling, and clustered randomized interference with fixed outcomes. Cluster/multisite residual designs, hierarchical/local multiplicity, and calibration remain. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired scalar/vector and subject-residual signs, unblocked/blocked 1–32-covariate whole-patient residual permutation, patient-then-specimen bootstrap, whole-cluster labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, exact randomized interference, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; cluster/multisite designs, calibration, and hierarchical/local multiplicity remain. |
