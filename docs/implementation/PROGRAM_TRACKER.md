...
| DIM-01 | active | IC-0126 plus checkpoint 197 provide strict physical-unit dimensionality, cuboid and exact finite voxel-union windows, anisotropic metrics, homogeneous 3-D K/L, and durable deterministic registered-serial execution with explicit section order, thickness, affine placement, volume identity, and missing planes. Watertight mesh/tetrahedral windows, transform-draw propagation into statistics, and provenance-complete real serial/longitudinal cohorts remain missing. |
