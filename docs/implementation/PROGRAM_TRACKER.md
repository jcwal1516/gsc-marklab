...
| BAY-03 | active | Gaussian and finite-variance Student-t hierarchies run on 284 ROIs nested in 121 patients; a beta-binomial hierarchy runs on 178 patients/1,542,389 exact CellViT annotation trials; and unadjusted plus complete-gender-adjusted patient-unit MSI/MSS beta-binomial regressions run on 105 labeled patients/886,751 trials. All pass durable replay where applicable, PyMC/NumPyro agreement, PPC, bounded sensitivity, and SBC. Repeated, crossed, varying-slope, ordinal/hurdle, and spatial hierarchies and additional identified covariates remain. |
...
| PLAT-01 | active | Immutable artifacts, catalog/store/cache, exact source/runtime identities, durable heads/ledger/recovery/replay, and typed unified dependency-free native/PyMC/POT execution exist, including seven PyMC workflows; dependency-bearing multi-node orchestration remains. |
...
| WS-41 | active | Durable Gaussian and robust Student-t partial pooling run on real ROI-within-patient data; durable beta-binomial pooling runs on 178 real CellViT patients; and durable unadjusted plus complete-gender-adjusted patient-unit MSI/MSS beta-binomial regressions run on the exact 105-patient label/count intersection. All pass PyMC/NumPyro agreement, PPC, sensitivity, and SBC. Repeated/crossed models, additional identified covariates, and random slopes remain. |
