...
| COH-01 | active | Scalar, unblocked/blocked 1–32-covariate adjusted, paired, functional, blocked and paired endpoint-family single-step/step-down Max-T, MMD/energy, fingerprint/region compatibility, equivalence, noninferiority, hierarchical bootstrap, repeated-measures, patient-row adjusted fixed/REML multisite, whole-cluster permutation, and exact randomized-interference workflows are runnable; adjusted cluster randomization and real multisite/cluster/interference validation remain. |
...
| FND-06 | active | Exact design owners cover patient labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, scalar and complete endpoint-vector paired signs, subject residuals, unblocked/blocked 1–32-covariate complete patient residual permutation, adjusted within-site effects, patient-then-specimen bootstrap, whole-cluster labels, complete cell-mark random labeling, and clustered randomized interference with fixed outcomes. Adjusted cluster randomization, hierarchical/local multiplicity, and calibration remain. |
...
| GEO-01D | active | Exact vector-polygon component areas drive largest-component fraction, area entropy, and perimeter/area; a separately declared physical-radius cell graph drives cross-edge fraction and neighbor-label entropy with random-label expectation. Multiscale stability, uncertainty, multiclass, patient inference, and real validation remain. |
...
| INF-01C | active | Single-step and step-down Max-T over one complete prespecified patient endpoint family are runnable for independent, exact-block, and paired-vector designs; hierarchical/local multiplicity families and calibration remain. |
...
| WF-01 | active | Typed keys, store-verified semantic artifacts, exact admission, composition, and replay include K/L, F/G/J, compartment interface/contact/fragmentation/mixing, categorical/probability connection, continuous correlation/weighted K, cross-K, real TCGA/Schürch fingerprints, and marked/Moran graphs. General schema, heterogeneous construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, spatial point/mark methods, compartment geometry/mixing, soft simplex composition/neighborhoods, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-23 | active | Declared scalar methods plus soft probability-simplex composition and fixed-radius neighborhoods share the bounded row-aligned MarkTable. Ordinal/vector, multiscale simplex callers, interchange, and canonical real-data import remain. |
...
| WS-30 | active | Standard-border point/mark methods, compartment mixing, and fixed-radius soft-simplex neighborhoods share exact window/index/geometry owners, deterministic traversal, hard limits, and durable execution. Translation/isotropic corrections, multiscale soft neighborhoods, multiple intensity estimators, and broader calibration remain. |
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired scalar/vector and subject-residual signs, unblocked/blocked 1–32-covariate whole-patient residual permutation, adjusted within-site effects, patient-then-specimen bootstrap, whole-cluster labels, blocked population-independence MMD/energy/functional/single-step/step-down Max-T families, exact randomized interference, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; adjusted cluster designs, calibration, and hierarchical/local multiplicity remain. |
