...
| WS-30 | active | Standard-border point/mark methods, Gaussian and exact binary-compartment inhomogeneous K/L/g, prespecified Gaussian bandwidth-selected K/L, binary/multiclass mixing, real four-radius categorical connection/cross-K/cross-g, and fixed/multiscale soft-simplex neighborhoods share exact window/index/geometry owners, deterministic traversal, hard limits, and durable execution. Translation/isotropic corrections, pinned external agreement, and broader calibration remain. |
