...
| FND-06 | active | Public InferenceDesign owns exact whole-unit schedules for patient-label and complete cell-mark random labeling. Conditional whole-pattern CSR drives homogeneous K/L, g, and F/G/J; a fixed gridded intensity drives conditioned inhomogeneous K/L nulls; categorical cross-g, probability, and continuous pair nulls permute complete rows without rebuilding geometry; real TCGA/Schürch tests use patients. Broader repeated/multisite/cluster/interference and multiplicity ownership remain. |
...
| PP-02 | active | One standard-border inhomogeneous K/L specialization consumes persisted Gaussian leave-one-out event intensities and a fixed gridded pilot, uses inverse-intensity pair/center ratio normalization, conditioned null ERL, hard bounds, and durable replay. Multiple estimators, pinned `Kinhom/Linhom` agreement, broader calibration, corrections, compartments, and real scale evidence remain. |
...
| PP-03A | active | One bounded homogeneous compact-support g specialization has hand/Python oracles, CSR inference, finite/resource guards, and durable replay. A provenance-bearing inhomogeneous intensity is now live, making inhomogeneous g the next bounded caller; pinned external agreement and broader null/edge calibration remain. |
...
| PP-05 | active | One explicit-bandwidth Gaussian estimator persists `n/(n-1)` leave-one-out event rows, deterministic window-mass quadrature, fixed probe intensities/masses, exact digests, finite floors, and hard evaluation/memory bounds consumed immediately by inhomogeneous K/L. Piecewise compartments, multiple estimators, broader cross-fitting, bandwidth selection, and external agreement remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, homogeneous/inhomogeneous K/L, g/cross-g, F/G/J, store-verified categorical/probability connection, continuous correlation/weighted K, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-30 | active | Standard-border homogeneous/inhomogeneous K/L, homogeneous g/cross-g, F/G/J, categorical/probability connection, continuous correlation/weighted K, and directed cross-K share exact window/index/geometry owners, deterministic nulls, ERL, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous g, multiple intensity estimators, and broader calibration remain. |
