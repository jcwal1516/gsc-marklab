...
| FND-03 | active | One exact SpatialGeometryPlan2D/SpatialIndex2D serves K/L, F/G/J, and the shared once-retained directed radius-pair plan now consumed by categorical, probability-weighted, and continuous mark-correlation workflows; observed/null evaluations reuse identical geometry under hard bounds. General edge-weight/bin plans and broader adoption remain. |
| FND-04 | active | A row-aligned typed MarkTable binds stable CellIds plus binary, probability, continuous, and provenance-bearing histologic-compartment categorical columns; declared analysis, Moran/Geary/variograms, categorical/probability connection, and continuous mark correlation are immediate callers. Ordinal, simplex, vector-reference, general categorical/interchange, real-IHC, and scale coverage remain. |
...
| MRK-01 | active | Exact categorical/probability mark connection and normalized continuous mark correlation share one bounded retained pair plan, complete-row random labeling, ERL, typed identities, and durable replay. Mark-weighted K remains the distinct open family. |
...
| MRK-01C | active | Exact standard-border K/L geometry and the global positive-mark product normalization are now live immediate prerequisites; the next caller must deliver cumulative mark-weighted K without merging it with correlation. |
...
| NUL-01B | active | Exact scalar, complete-vector, categorical, dense-probability, and continuous whole-row random labeling are runnable; all three mark-pair workflows reuse one fixed geometry plan with explicit ERL families. Broader typed mark/strata calibration and stable promotion remain. |
...
| PLAT-01 | active | Immutable artifacts, exact identities, durable heads/ledger/recovery/replay, and typed native/PyMC/POT execution drive K/L, F/G/J, categorical/probability connection, continuous mark correlation, cross-K, real TCGA M0–M4/M6, Schürch CODEX, and seven PyMC workflows. General multi-node orchestration remains. |
...
| WF-01 | active | Typed keys, store-verified semantic artifacts, exact admission, composition, and replay include K/L, F/G/J, categorical/probability connection, continuous mark correlation, cross-K, real TCGA/Schürch fingerprints, and marked/Moran graphs. General schema, heterogeneous construction, resource planning, parallel scheduling, and whole-graph resume remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, K/L, F/G/J, store-verified categorical/probability connection, continuous mark correlation, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-23 | active | Declared analysis, Moran/Geary/variograms, categorical/probability connection, continuous mark correlation, and cross-K share the bounded row-aligned MarkTable. General categorical/ordinal/simplex/vector/interchange and canonical real-data import remain. |
...
| WS-30 | active | Standard-border K/L, F/G/J, categorical/probability connection, continuous mark correlation, and directed cross-K share exact window/index/geometry owners, deterministic nulls, ERL, hard limits, and durable execution. Translation/isotropic corrections, inhomogeneous K/L, pair-correlation g/cross-g, mark-weighted K, and intensity estimation remain. |
