...
| COH-01 | active | Scalar, paired, functional, blocked single-step Max-T, MMD/energy, fingerprint/region compatibility, equivalence, noninferiority, hierarchical bootstrap, repeated-measures, patient-row fixed/REML multisite, whole-cluster permutation, and exact randomized-interference workflows are runnable; real CPTAC CellViT patient-unit four-endpoint Max-T evidence is bundled, while covariate-adjusted designs and real multisite/cluster/interference validation remain. |
...
| FND-06 | active | Exact design owners cover patient labels, blocked population-independence MMD/energy/functional/Max-T families, paired differences, subject residuals, patient-then-specimen bootstrap, whole-cluster labels, complete cell-mark random labeling, and clustered randomized interference with fixed outcomes. Conditional whole-pattern/fixed-pilot nulls and complete-row pair nulls remain method-bound; broader multiplicity/calibration ownership remains. |
...
| WS-31 | active | Conditional CSR, reused ERL, scalar patient-label, exact paired-difference/subject-residual signs, patient-then-specimen bootstrap, whole-cluster labels, blocked population-independence MMD/energy/functional/Max-T families, exact randomized interference, complete-vector embedding nulls, and shared blocked cell-mark/variogram schedules are runnable; calibration and broader multiplicity require further FND-06 slices. |
