...
| FND-03 | active | One exact SpatialGeometryPlan2D/SpatialIndex2D serves homogeneous/inhomogeneous K/L, g, F/G/J, compartment physical-radius cell mixing, and the shared once-retained directed radius-pair plan consumed by cross-g, categorical/probability connection, continuous mark correlation, and mark-weighted K; observed/null evaluations reuse exact geometry under hard bounds. General edge-weight/bin plans and broader adoption remain. |
| FND-04 | active | A row-aligned typed MarkTable binds stable CellIds plus binary, scalar probability, continuous, histologic categorical, and contiguous probability-simplex columns with exact status/provenance. Soft class composition/entropy consumes complete CellViT-compatible simplex rows without thresholding; existing scalar spatial callers remain. Ordinal, vector-reference, broader categorical/interchange, real-IHC, and spatial simplex coverage remain. |
...
| WS-12 | active | Typed durable execution covers native/POT, PyMC, homogeneous/inhomogeneous K/L and g, cross-g, F/G/J, compartment geometry/mixing, soft simplex composition, store-verified categorical/probability connection, continuous correlation/weighted K, cross-K, marked/Moran graphs, and real TCGA/Schürch workflows with cross-process replay. General DAG/resource/parallel/whole-graph resume remains. |
...
| WS-23 | active | Declared analysis, Moran/Geary/variograms, categorical/probability connection, continuous correlation/weighted K, cross-K, and soft probability-simplex composition share the bounded row-aligned MarkTable. Ordinal/vector, broader categorical/simplex spatial callers, interchange, and canonical real-data import remain. |
