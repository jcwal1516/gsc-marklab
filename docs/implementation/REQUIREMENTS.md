...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links, strict records, and the direct-patch structural graph are implemented, while separate physical/support/table/link receipts, derived/cell graphs, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values and the direct-patch eighteen-role structural graph pass exact profile, dependency, canonical-payload, managed-integrity, resource, and dual-review gates; physical/support/table/link receipts, derived/cell graphs, eight physical families, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values plus direct-patch structural graph exist; FND-04/C-06 measurement provenance plus separate C-05 physical/support/table/link receipts and remaining derived/cell graphs remain prerequisites for full closure |
