...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact Arrow/Parquet physical families pass profile, dependency, canonical-row, managed-integrity, resource, determinism, and review gates; five support/link families have separate receipts plus one paired-link receipt, while support/matrix receipts, derived graphs/finalization, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact physical families exist; five support/link families have graph-bound receipts, while FND-04/C-06 measurement provenance plus C-05 support/table/derived graph receipts and source correspondence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover the logical and strict-record substrate, direct-patch/cell-link/patch-region input graphs, and all eight exact Arrow/Parquet families. Footprint, overlap, cell-assignment, cell-edge, and patch-region have separate graph-bound receipts plus one format-neutral link-pair receipt; support/matrix receipts, derived graphs/finalization, fuzz/scale evidence, and closure remain |
