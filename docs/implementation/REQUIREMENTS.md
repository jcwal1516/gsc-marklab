...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links, strict records, direct-patch/cell-link/patch-region input graphs, all eight exact physical families, footprint/overlap/assignment/edge/patch-region/direct-patch receipts, and the region-from-patches support/derived graph are implemented, while region finalization/table receipt, derived slide authority, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact Arrow/Parquet physical families pass profile, dependency, canonical-row, managed-integrity, resource, determinism, and review gates; direct patch support/table plus five support/link physical families have separate receipts, cell-link has one paired receipt, and region-from-patches support plus the derived-region graph have receipt authority; region finalization/table receipt, both slide paths, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact physical families exist; direct patch support/table, five support/link physical families, and region support/derived provenance have graph-bound receipts, while FND-04/C-06 measurement provenance plus physical derived region/slide table receipts and source correspondence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover the logical and strict-record substrate, direct-patch/cell-link/patch-region input graphs, all eight exact Arrow/Parquet families, five structural/link receipt families, direct patch support/table receipts, the region-from-patches support receipt, and the nine-role derived-region graph. Deterministic region finalization/table receipt, both slide paths, fuzz/scale evidence, and closure remain |
...
| WS-24 | active/data available with blockers | C-04 cell-vector substrate is complete. C-05 has its synthetic/domain logical and strict-record substrate, direct-patch/cell-link/patch-region input graphs, all eight exact Arrow/Parquet physical families, receipts for footprint/overlap/cell assignment/cell edge/patch-region/direct patch support/direct patch table, the format-neutral cell-link pair, and region-from-patches support/derived graph authority. Deterministic region finalization/table receipt, both slide paths, fuzz/scale closure, and source-adapter correspondence remain. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide source profiles are inadmissible. General measurement status follows in C-06 |
