...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links, strict records, direct-patch and cell-link input graphs, four physical families, and footprint/overlap/assignment/edge plus paired-link receipts are implemented, while the other four physical families, support/matrix/patch-region receipts, derived graphs, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, the direct-patch and cell-link input graphs, and exact Arrow/Parquet footprint/overlap/assignment/edge artifacts with separate receipts and one paired-link receipt pass profile, dependency, canonical-payload, managed-integrity, resource, and dual-review gates; four physical families, support/matrix/patch-region receipts, derived graphs, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, direct-patch and cell-link input graphs, and the first four physical families with graph-bound receipts exist; FND-04/C-06 measurement provenance plus the remaining C-05 matrix/patch-region physical and support/table/derived receipts remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover the logical and strict-record substrate, direct-patch and cell-link input graphs, and exact Arrow/Parquet footprint, overlap, cell-assignment, and cell-edge families with separate graph-bound receipts plus one format-neutral link-pair receipt. The three matrix families, patch-region family, support/matrix/patch-region receipts, derived graphs, fuzz/scale evidence, and closure remain |
...
| WS-24 | active/data available with blockers | C-04 cell-vector substrate is complete. C-05 has its synthetic/domain logical and strict-record substrate, direct-patch and cell-link input graphs, and exact Arrow/Parquet physical validation/publication plus receipts for footprint, overlap, cell assignment, and cell edge artifacts and their format-neutral link pair. Four of eight physical families, support/matrix/patch-region receipts, derived graphs, fuzz/scale closure, and source-adapter correspondence remain. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide source profiles are inadmissible. General measurement status follows in C-06 |
