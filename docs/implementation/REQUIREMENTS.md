...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links plus strict patch source-identity and normalization values/codecs are implemented, while remaining records, physical persistence, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 expected sets, context/footprints/overlap, typed logical tables, both vector-free link families, and strict patch source set/map/row-link/normalization values/codecs pass digest/resource gates and dual review; remaining records, physical profiles, graph publication, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical tables/context/links plus strict patch source-identity/normalization values exist; FND-04/C-06 measurement provenance plus remaining C-05 records, graphs, and physical persistence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover expected sets/context/footprints, typed tables, overlap, complete vector-free links, exhaustive sparse patch-region declarations/links, and strict patch source set/map/row-link/normalization values/codecs; the current record boundary passes 7 focused plus private structural/allocation limits after dual review. Remaining records, physical profiles, graph/scale/closure remain |
...
| WS-24 | active/data available with blockers | C-04 cell-vector substrate is complete. C-05 now has synthetic/domain-level expected sets, context/footprints/overlap, typed logical tables, both link families, and strict source-identity/normalization values/codecs, but producer/support/derivation/provenance records, physical profiles, and graph validation remain. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide profiles are inadmissible. General measurement status follows in C-06 |
