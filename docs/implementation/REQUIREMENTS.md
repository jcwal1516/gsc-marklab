...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 expected sets, context/footprints/overlap, typed logical tables, and both vector-free link families pass digest/resource/work-budget gates and dual review; strict records, physical profiles, graph publication, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical tables/context/footprints/overlap plus cell-patch and declared patch-region links exist; FND-04/C-06 measurement provenance plus C-05 strict records and physical persistence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved logical checkpoints cover expected sets/context/footprints, typed tables, overlap, complete vector-free cell modes, and exhaustive sparse patch-region declarations/links; the new boundary passes 9 focused plus private 400M-row and checked-product tests after dual review. Strict records, physical profiles, graph/scale/closure remain |
