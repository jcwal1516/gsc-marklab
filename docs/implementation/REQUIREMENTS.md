...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links, strict records, all required graphs, all eight exact physical families, and direct/derived candidate-bound receipts are implemented, while C-05 closure evidence, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, direct-patch/cell-link/patch-region/derived input graphs, all eight exact Arrow/Parquet families, and direct patch plus deterministically finalized region/both-slide candidate-bound receipts pass focused resource, lineage, physical, and review gates; fuzz/scale/allocation/RSS evidence and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, required input/provenance graphs, all eight exact physical families, and direct patch plus deterministically finalized region/both-slide graph-bound receipts exist; C-05 closure evidence, FND-04/C-06 measurement provenance, and source correspondence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved milestones cover the logical/strict-record substrate, required support/input/provenance graphs, all eight exact Arrow/Parquet families, structural/link receipts, direct patch authority, deterministic region finalization/receipt, and both deterministic slide finalization/receipt paths. Fuzz, scale, allocation, RSS, and closure evidence remain |
...
| WS-24 | active/data available with blockers | C-04 cell-vector substrate is complete. C-05 has its synthetic/domain logical and strict-record substrate, required support/input/provenance graphs, all eight exact Arrow/Parquet physical families, structural/link receipts, direct patch authority, deterministic weighted-region authority, and both arithmetic-mean singleton-slide receipt paths. Fuzz/scale/allocation/RSS closure and source-adapter correspondence remain. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide source profiles are inadmissible. General measurement status follows in C-06 |
