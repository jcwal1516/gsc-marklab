...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact Arrow/Parquet physical families pass profile, dependency, canonical-row, managed-integrity, resource, determinism, and review gates; direct patch support/table plus five support/link physical families have separate receipts and cell-link has one paired receipt, while region/slide support receipts, derived graphs/finalization, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and all eight exact physical families exist; direct patch support/table and five support/link physical families have graph-bound receipts, while FND-04/C-06 measurement provenance plus derived region/slide support/table graph receipts and source correspondence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover the logical and strict-record substrate, direct-patch/cell-link/patch-region input graphs, and all eight exact Arrow/Parquet families. Footprint, overlap, cell-assignment, cell-edge, patch-region, direct patch support, and direct patch table have separate graph-bound receipts plus one format-neutral cell-link pair receipt; region/slide support receipts, derived graphs/finalization, fuzz/scale evidence, and closure remain |
