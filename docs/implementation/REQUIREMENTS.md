...
| WF-01 | Typed composable workflow DAG | PLAT-01 | Lead | planned | New workflow schema/API | Pending |
| BACK-01 | Versioned backend registry | PLAT-01, WF-01 | Lead | planned | Backend manifests/CLI | Pending |
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | planned | New stable data contracts | Pending |
...
|---|---|---|---|---|---|---|
| FND-01 | Typed identity and cohort hierarchy | DATA-01 | Lead | planned | Infrastructure only | Pending |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | planned | No model-specific claim | Checkpoint/vector/run provenance found; pickle conversion, stable row identity, extraction fields, and patch links pending |
...
| COH-01 | Patient-level cohort inference | FND-01, FND-06 | Lead | planned | No population claim | Pending |
