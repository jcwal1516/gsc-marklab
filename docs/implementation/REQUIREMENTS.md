...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 logical/record values, the direct-patch/cell-link/patch-region input graphs, and exact Arrow/Parquet footprint/overlap/assignment/edge/patch-region artifacts with separate receipts and one paired-link receipt pass profile, dependency, canonical-payload, managed-integrity, resource, and review gates; the three matrix physical families, support/matrix receipts, derived graphs, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical/record values, direct-patch/cell-link/patch-region input graphs, and the first five physical families with graph-bound receipts exist; FND-04/C-06 measurement provenance plus the remaining C-05 matrix physical and support/table/derived receipts remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover the logical and strict-record substrate, direct-patch/cell-link/patch-region input graphs, and exact Arrow/Parquet footprint, overlap, cell-assignment, cell-edge, and patch-region families with separate graph-bound receipts plus one format-neutral link-pair receipt. The three matrix families, support/matrix receipts, derived graphs, fuzz/scale evidence, and closure remain |
