...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links plus strict source, normalization, support, derivation, producer, assessment, and four provenance values/codecs are implemented, while artifact graphs/receipts, physical persistence, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 expected/context/support/link/table values plus strict source, normalization, derivation, producer, assessment, and four provenance variants pass digest/resource gates and dual review; artifact-record profiles, graph verification/receipts, physical profiles, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical tables/context/links plus strict source/support/derivation/producer/assessment/provenance values exist; FND-04/C-06 measurement provenance plus C-05 graph receipts and physical persistence remain prerequisites for full closure |
