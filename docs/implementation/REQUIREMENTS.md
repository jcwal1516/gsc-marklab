...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifacts, C-04 cell embeddings, and C-05 bounded multiscale embedding/link infrastructure are complete; C-06 and broader durable payload alignment remain |
...
| FND-04 | Typed marks and measurement provenance | FND-01 | Lead | active | Infrastructure only | C-06 first slice adds the exact four-state measurement-origin vocabulary and binds C-05 direct/derived provenance to an immediate patch computation; general CellId-keyed marks, units, thresholds, missingness, scalar/vector/posterior kinds, and adapters remain pending |
...
| C-06 | General marks/status | C-01, C-03 | Lead | active | Data/artifact tests | First vertical slice: four provenance statuses, exact C-05 direct/derived mapping, and bounded observable patch-overlap dispersion pass focused/oracle/resource/workspace evidence; general marks remain pending |
...
| WS-24 | active/data available with blockers | C-04 cell-vector and C-05 bounded multiscale embedding/link infrastructure are complete, including fuzz/differential/DHAT/RSS scale closure. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide source profiles remain inadmissible. General measurement status follows in C-06 |
