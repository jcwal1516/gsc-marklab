...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 cell and C-05 multiscale storage/link substrates are complete; FND-04/C-06 measurement provenance, real-source correspondence, and scientific callers remain prerequisites for broader closure |
