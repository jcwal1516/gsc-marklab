...
| FND-04 | Typed marks and measurement provenance | FND-01 | Lead | active | Infrastructure only | C-06 adds the exact four-state measurement-origin vocabulary, five immediate embedding computations including binary-centroid and probability–embedding covariance diagnostics, one CellId/frame/provenance-bound binary/optional-probability engine/project workflow with exact threshold evidence, a dedicated cacheable project execution for the exact binary-centroid question, one semantic declared pre/post workflow, and exact descriptive binary-prevalence change retaining both contexts; general mark kinds, units/modalities, missingness, durable formats, producer proof, and adapters remain pending |
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 cell and C-05 multiscale storage/link substrates plus bounded binary-group centroid, probability cross-covariance, patch-overlap, patch-to-derived-region, and exact slide aggregation-path descriptive callers are complete; real-source correspondence, geometry/window truth, and formal spatial embedding science remain prerequisites for broader closure |
...
| C-06 | General marks/status | C-01, C-03 | Lead | active | Data/artifact tests | Nine vertical slices pass: four provenance statuses plus bounded patch-overlap dispersion; a borrowed declared scalar-pattern direct/project workflow with compact runtime identity, exact provenance/threshold binding, legacy numerical parity, and unchanged result-0.3 bytes; bounded declared patch-to-finalized-region aggregation dispersion; a runtime-only semantic pre/post workflow; exact descriptive binary-prevalence change over existing scheduler outputs; lineage-exact discrepancy between both completed slide aggregation paths; exact binary-group cell-embedding centroid discrepancy; dense-probability cell-embedding cross-covariance energy; and one semantic-store-verified cacheable project execution of the exact centroid question. General marks and durable producer proof remain pending |
...
| WS-23 | active | C-06 supplies measurement status, one exact declared binary/optional-probability engine/project workflow, a dedicated project execution of the binary-centroid question, semantic pre/post comparison, binary-prevalence change, and verified cell-embedding consumers for both binary assignments and dense probabilities; general typed marks, formats, missingness, durable producer proof, and adapters remain |
| WS-24 | active/data available with blockers | C-04/C-05 embedding infrastructure and C-06's bounded descriptive callers, including binary centroids, probability cross-covariance, and exact cross-path slide discrepancy, are complete. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide source profiles remain inadmissible |
...
| WS-50 | active/two bounded synthetic slices | Exact declared binary-group centroid discrepancy and dense-probability population cross-covariance energy over verified present cell embeddings are complete; the centroid question also has one semantic-store-verified cacheable project execution. Spatial covariance/variograms, graph/kernel/local-diversity/boundary/retrieval/cross-sample designs, real-source promotion, and inferential validation remain planned/data-dependent |
