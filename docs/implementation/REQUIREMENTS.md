...
| DATA-01 | Identity, hierarchy, modalities, coordinates, and units | WS-B | Lead | active | New stable data contracts | C-01 identity/hierarchy, C-02 coordinates, C-03 artifact substrate, and C-04 cell-embedding substrate complete; C-05 logical tables/context/links plus strict source, normalization, support, derivation, producer, and assessment values/codecs are implemented, while provenance/graphs, physical persistence, C-06, and broader durable payload alignment remain |
...
| EMB-PATCH | Patch/region/slide embeddings and links | DATA-01, artifact layer | Lead | active | New artifact contract | C-05 expected/context/support/link/table values plus strict source, normalization, derivation, producer, and assessment records pass digest/resource gates and dual review; provenance, physical profiles, graph publication, scale evidence, and closure remain; no real source profile promoted |
...
| FND-05 | Cell/patch embedding artifacts | FND-01, FND-04 | Lead | active | No model-specific claim | C-04 bounded cell-table substrate complete and C-05 logical tables/context/links plus strict source/support/derivation/producer/assessment values exist; FND-04/C-06 measurement provenance plus C-05 provenance, graphs, and physical persistence remain prerequisites for full closure |
...
| C-05 | Patch/region/slide embedding links | C-02–C-04 | Lead | active | Data/artifact tests | Approved checkpoints cover expected/context/footprints, typed tables, overlap, complete vector-free links, strict patch source chain/normalization, four support variants, deterministic derivation, both cell-link producer modes, and assessment wire; the combined record suite passes 11 focused cases plus private structural/allocation limits after dual review. Provenance, artifact graphs/receipts, physical profiles, scale, and closure remain |
...
| WS-24 | active/data available with blockers | C-04 cell-vector substrate is complete. C-05 now has synthetic/domain-level expected/context/footprints/overlap, typed logical tables, both link families, and strict source/support/derivation/producer/assessment records, but provenance, physical profiles, receipts, and graph validation remain. Authorized candidates still lack promotable canonical identity/context/provenance/linkage; region/slide profiles are inadmissible. General measurement status follows in C-06 |
