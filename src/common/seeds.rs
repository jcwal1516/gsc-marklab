...
pub(crate) enum SeedEndpoint {
    ...
    TranslationSpatialCsr = 0x7472_616e_735f_6373,
    TranslationPairCorrelationCsr = 0x7472_616e_735f_6763,
    IsotropicSpatialCsr = 0x6973_6f74_726f_6373,
    IsotropicPairCorrelationCsr = 0x6973_6f74_726f_6763,
...
mod tests {
    ...
    fn every_declared_endpoint_has_a_distinct_stream() {
        let endpoints = [
            ...
            SeedEndpoint::TranslationSpatialCsr,
            SeedEndpoint::TranslationPairCorrelationCsr,
            SeedEndpoint::IsotropicSpatialCsr,
