...
pub use marklab_embeddings::{
    ...
    CellVitCsvField, CellVitNpyMatrix, CellVitNpySummary, CsvFailure, EmbeddingArtifactGraphError,
    EmbeddingDtype, EmbeddingError, EmbeddingQcSummary, EmbeddingSpatialContext, EmbeddingStatus,
    ExpectedCellSet, ImportFailure, ManifestFailure, NpyFailure, NpyVersion, PatchBoundaryPolicy,
    PositiveRational, ReconciliationFailure, SourceBundleBudgets, SourceBundleError,
    SourceFileKind, SourceIoFailure, SourceIoOperation, VerifiedCellEmbeddingArtifactGraph,
    VerifiedCellEmbeddingRowLinkArtifact, VerifiedCellEmbeddingTableArtifact,
};
