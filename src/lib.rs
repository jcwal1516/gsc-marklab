...
pub use marklab_embeddings::{
    ...
    finalize_slide_embedding_table_from_regions, ArtifactAvailabilityFailure, CanonicalDecimal,
    CellEmbeddingArtifact, CellEmbeddingArtifactRole, CellEmbeddingBlock,
    ...
    CellIdentityMapEntry, CellPatchAnchor, CellPatchAssignment, CellPatchAssignmentMode,
    CellPatchAssignmentStatus, CellPatchContributor, CellPatchEdge, CellPatchLink,
    CellPatchLinkBindings, CellPatchLinkProducer, CellPatchWeight, CellVitCsvField,
    CellVitNpyMatrix, CellVitNpySummary, CsvFailure, DeclaredCellPatchAssignment,
    ...
    EmbeddingError, EmbeddingFinalizationBudgets, EmbeddingQcSummary, EmbeddingSpatialContext,
    EmbeddingStatus, ExpectedCellSet, ExpectedPatchSet, ExpectedRegionSet, ExpectedSlideSet,
    ImportFailure, ManifestFailure, MultiscaleArtifactBinding, MultiscaleDirectPatchInputArtifacts,
