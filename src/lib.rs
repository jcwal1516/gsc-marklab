...
pub use marklab_embeddings::{
    finalize_region_embedding_table_from_patches, ArtifactAvailabilityFailure, CanonicalDecimal,
    ...
    DerivedRegionEmbeddingTableCandidate, EffectiveReceptiveField, EmbeddingArtifactGraphError,
