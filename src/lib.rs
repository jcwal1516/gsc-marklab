...
pub use marklab_embeddings::{
    ...
    CellVitCsvField, CellVitNpyMatrix, CellVitNpySummary, CsvFailure, EffectiveReceptiveField,
    EmbeddingArtifactGraphError, EmbeddingDtype, EmbeddingEntityKind, EmbeddingError,
