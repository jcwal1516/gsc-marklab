...
use marklab_topology::{
    ...
    AlphaPersistenceWorkerRequest, ConnectivityTransitionSpec, WitnessDimensionStabilityResult,
    WitnessPersistenceResult, WitnessPersistenceSpec, WitnessPersistenceStabilityResult,
    WitnessPersistenceStabilitySpec, WitnessPersistenceWorkerRequest,
    WitnessPerturbationStabilityResult,
};
use serde::Serialize;
use thiserror::Error;
...
pub(crate) fn execute_witness_persistence_stability(
    ...
    for (replicate, result) in results.iter().enumerate() {
