...
pub(super) fn run_beta_binomial_group_gender_slide_hierarchy_agreement_cli(
...
pub(super) fn run_beta_binomial_group_gender_slide_hierarchy_sbc_cli() -> Result<(), BayesCliError>
{
...
pub(super) fn run_cli() -> Result<(), BayesCliError> {
    match BayesCli::parse_from(std::env::args_os()).command {
        ...
        BayesTopLevel::Bayes {
            command:
                BayesCommand::BetaBinomialGroupGenderRegressionSensitivity {
                    input,
                    reference_group,
                    comparison_group,
                    reference_gender,
        ...
        BayesTopLevel::Bayes {
            command:
                BayesCommand::BetaBinomialGroupGenderRegressionSbc {
                    input,
                    reference_group,
                    comparison_group,
                    reference_gender,
        ...
        BayesTopLevel::Bayes {
            command:
                BayesCommand::BetaBinomialGroupRegressionSbc {
                    input,
                    reference_group,
                    comparison_group,
                    intercept_prior_mean,
