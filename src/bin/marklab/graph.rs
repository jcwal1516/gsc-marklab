...
use marklab_graph::{
    ...
    graph_heat_workflow, graph_scattering_workflow, graph_sparse_radius_heat_workflow,
    ...
    GraphSparseRadiusHeatSpec, GraphSpectralSpec, GraphSpectrumNullSpec, GraphWaveletSpec,
